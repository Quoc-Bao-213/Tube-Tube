...
const videoRowCardVatiants = cva("group flex min-w-0", {
  variants: {
    size: {
      default: "gap-4",
      compact: "gap-2",
...
interface VideoRowCardProps extends VariantProps<typeof videoRowCardVatiants> {
...
export const VideoRowCardSkeleton = ({
  size = "default",
}: VariantProps<typeof videoRowCardVatiants>) => {
  return (
    <div className={videoRowCardVatiants({ size })}>
      {/* Thumbnail skeleton */}
